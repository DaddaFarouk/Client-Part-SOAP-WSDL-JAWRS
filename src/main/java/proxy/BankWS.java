 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9191/BankService?wsdl")
public class BankWS
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9191/BankService?wsdl");
